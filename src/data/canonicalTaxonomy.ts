...
\\text{পুত্রদের মধ্যে ৫০\\% বর্ণান্ধ এবং কন্যারা সকলে দৃষ্টিসম্পন্ন (৫০\\% বাহক)।}`
  ...
  // --- PHYSICS 1ST & 2ND PAPER MCQS ---
  {
    ...
    question_format: 'MCQ',
    difficulty_tier: 'easy',
    stem_text: '$\\vec{A} = 2\\hat{i} + 2\\hat{j} - \\hat{k}$ এবং $\\vec{B} = 6\\hat{i} - 3\\hat{j} + 2\\hat{k}$ হলে $\\vec{A}\\cdot\\vec{B}$ এর মান কত?',
    mcq_options: [
      { key: 'A', text: '4' },
      { key: 'B', text: '8' },
      { key: 'C', text: '16' },
    ...
    correct_option: 'A',
    full_solution_latex: '\\vec{A}\\cdot\\vec{B} = (2)(6) + (2)(-3) + (-1)(2) = 12 - 6 - 2 = 4',
    is_verified: true,
  ...
  },
  {
    ...
    question_format: 'MCQ',
    difficulty_tier: 'medium',
    stem_text: 'একটি প্রক্ষেপকের সর্বাধিক অনুভূমিক পাল্লা $R_{\\max} = 100\\text{ m}$ হলে এর সর্বাধিক উচ্চতা ($H$) কত?',
    mcq_options: [
      { key: 'A', text: '$25\\text{ m}$' },
      { key: 'B', text: '$50\\text{ m}$' },
      { key: 'C', text: '$100\\text{ m}$' },
      { key: 'D', text: '$12.5\\text{ m}$' }
    ],
    correct_option: 'A',
    full_solution_latex: 'R_{\\max} = \\frac{v_0^2}{g} = 100\\text{ m}\\text{। সর্বোচ্চ পাল্লার ক্ষেত্রে নিক্ষেপণ কোণ } \\theta = 45^\\circ \\implies H = \\frac{v_0^2\\sin^2 45^\\circ}{2g} = \\frac{R_{\\max}}{4} = \\frac{100}{4} = 25\\text{ m}',
    is_verified: true,
    created_at: '2024-02-01T00:00:00Z'
  },
  {
    ...
    question_format: 'MCQ',
    difficulty_tier: 'easy',
    stem_text: '$10\\text{ kg}$ ভরের একটি চাকার চক্রগতির ব্যাসার্ধ $0.5\\text{ m}$ হলে এর জড়তার ভ্রামক কত?',
    mcq_options: [
      { key: 'A', text: '$2.5\\text{ kg}\\cdot\\text{m}^2$' },
      { key: 'B', text: '$5.0\\text{ kg}\\cdot\\text{m}^2$' },
      { key: 'C', text: '$25\\text{ kg}\\cdot\\text{m}^2$' },
      { key: 'D', text: '$1.25\\text{ kg}\\cdot\\text{m}^2$' }
    ],
    correct_option: 'A',
    full_solution_latex: 'I = Mk^2 = 10 \\times (0.5)^2 = 10 \\times 0.25 = 2.5\\text{ kg}\\cdot\\text{m}^2',
    is_verified: true,
    created_at: '2024-02-01T00:00:00Z'
  },
  {
    ...
    question_format: 'MCQ',
    difficulty_tier: 'medium',
    stem_text: 'একটি স্প্রিং-এর বল ধ্রুবক $k = 200\\text{ N/m}$। একে $10\\text{ cm}$ সংকুচিত করলে সঞ্চিত বিভব শক্তি কত হবে?',
    mcq_options: [
      { key: 'A', text: '$1\\text{ J}$' },
      { key: 'B', text: '$2\\text{ J}$' },
      { key: 'C', text: '$10\\text{ J}$' },
    ...
    correct_option: 'A',
    full_solution_latex: 'U = \\frac{1}{2}kx^2 = \\frac{1}{2} \\times 200 \\times (0.1\\text{ m})^2 = 100 \\times 0.01 = 1\\text{ J}',
    is_verified: true,
    created_at: '2024-02-01T00:00:00Z'
  },
  {
    ...
    correct_option: 'B',
    full_solution_latex: 'E_k = E_p \\implies \\frac{1}{2}k(A^2 - x^2) = \\frac{1}{2}kx^2 \\implies A^2 - x^2 = x^2 \\implies 2x^2 = A^2 \\implies x = \\frac{A}{\\sqrt{2}}',
    is_verified: true,
    created_at: '2024-02-01T00:00:00Z'
  },
  {
    ...
    mcq_options: [
      { key: 'A', text: '$546\\text{ K}$' },
      { key: 'B', text: '$1092\\text{ K}$' },
      { key: 'C', text: '$819^\\circ\\text{C}$' },
      { key: 'D', text: 'B ও C উভয়ই' }
    ],
    correct_option: 'D',
    full_solution_latex: 'c \\propto \\sqrt{T} \\implies \\frac{c_2}{c_1} = \\sqrt{\\frac{T_2}{T_1}} \\implies 2 = \\sqrt{\\frac{T_2}{273}} \\implies T_2 = 4 \\times 273 = 1092\\text{ K} = 819^\\circ\\text{C}',
    is_verified: true,
    created_at: '2024-02-01T00:00:00Z'
  },
  {
    id: 'q_phy2_mcq_thermo1',
    scope: 'global_official',
    subject_id: 'phy',
    paper_id: 'phy_2',
    chapter_id: 'phy_2_ch1',
    ...
    question_format: 'MCQ',
    difficulty_tier: 'medium',
    stem_text: 'একটি কার্নো ইঞ্জিনের তাপগ্রাহকের তাপমাত্রা $300\\text{ K}$ এবং দক্ষতা $40\\%$ হলে উৎসের তাপমাত্রা ($T_1$) কত?',
    mcq_options: [
      { key: 'A', text: '$500\\text{ K}$' },
      { key: 'B', text: '$450\\text{ K}$' },
      { key: 'C', text: '$750\\text{ K}$' },
      { key: 'D', text: '$600\\text{ K}$' }
    ],
    correct_option: 'A',
    full_solution_latex: '\\eta = 1 - \\frac{T_2}{T_1} \\implies 0.40 = 1 - \\frac{300}{T_1} \\implies \\frac{300}{T_1} = 0.60 \\implies T_1 = \\frac{300}{0.60} = 500\\text{ K}',
    is_verified: true,
    created_at: '2024-02-01T00:00:00Z'
  },
  {
    ...
    question_format: 'MCQ',
    difficulty_tier: 'medium',
    stem_text: 'একটি গ্যালভানোমিটারের রোধ $99\\ \\Omega$। এর মধ্য দিয়ে মোট তড়িৎ প্রবাহের $1\\%$ পাঠাতে হলে কত মানের শান্ট যুক্ত করতে হবে?',
    mcq_options: [
      { key: 'A', text: '$1\\ \\Omega$' },
      { key: 'B', text: '$0.99\\ \\Omega$' },
      { key: 'C', text: '$10\\ \\Omega$' },
      { key: 'D', text: '$9.9\\ \\Omega$' }
    ],
    correct_option: 'A',
    full_solution_latex: 'I_g = \\frac{1}{100}I \\implies n = 100 \\implies S = \\frac{G}{n - 1} = \\frac{99}{100 - 1} = \\frac{99}{99} = 1\\ \\Omega',
    is_verified: true,
    created_at: '2024-02-01T00:00:00Z'
  },

  // --- CHEMISTRY 1ST & 2ND PAPER MCQS ---
  {
    id: 'q_chem1_mcq_qual1',
    scope: 'global_official',
    subject_id: 'chem',
    paper_id: 'chem_1',
    ...
    question_format: 'MCQ',
    difficulty_tier: 'easy',
    stem_text: '$d$-উপস্তরের জন্য সহকারী কোয়ান্টাম সংখ্যা ($l$) এর মান কত?',
    mcq_options: [
      { key: 'A', text: '0' },
      { key: 'B', text: '1' },
      { key: 'C', text: '2' },
    ...
    correct_option: 'C',
    full_solution_latex: 's\\text{ এর জন্য } l=0, \\ p\\text{ এর জন্য } l=1, \\ d\\text{ এর জন্য } l=2, \\ f\\text{ এর জন্য } l=3\\text{। সুতরাং } d\\text{-উপস্তরের জন্য } l = 2।',
    is_verified: true,
    created_at: '2024-02-01T00:00:00Z'
  },
  {
    id: 'q_chem1_mcq_bond1',
    scope: 'global_official',
    subject_id: 'chem',
    paper_id: 'chem_1',
    ...
    question_format: 'MCQ',
    difficulty_tier: 'medium',
    stem_text: '$PCl_5$ অণুর কেন্দ্রীয় ফসফরাস পরমাণুতে কোন ধরনের সংকরায়ন ঘটে?',
    mcq_options: [
      { key: 'A', text: '$sp^3$' },
      { key: 'B', text: '$sp^3d$' },
      { key: 'C', text: '$sp^3d^2$' },
    ...
    correct_option: 'B',
    full_solution_latex: 'H = \\frac{1}{2}(V + M - C + A) = \\frac{1}{2}(5 + 5 - 0 + 0) = 5 \\implies sp^3d\\text{ সংকরায়ন (ত্রিকোণীয় দ্বিপিরামিডীয় জ্যামিতি)।}',
    is_verified: true,
    created_at: '2024-02-01T00:00:00Z'
  },
  {
    ...
    question_format: 'MCQ',
    difficulty_tier: 'easy',
    stem_text: '$0.005\\text{ M } H_2SO_4$ জলীয় দ্রবণের pH এর মান কত?',
    mcq_options: [
      { key: 'A', text: '2.0' },
      { key: 'B', text: '2.3' },
      { key: 'C', text: '1.7' },
    ...
    correct_option: 'A',
    full_solution_latex: 'H_2SO_4 \\text{ একটি দ্বিক্ষারকীয় অম্ল। } [H^+] = 2 \\times 0.005 = 0.01\\text{ M} = 10^{-2}\\text{ M} \\implies \\text{pH} = -\\log(10^{-2}) = 2.0',
    is_verified: true,
    created_at: '2024-02-01T00:00:00Z'
  },
  {
    ...
    question_format: 'MCQ',
    difficulty_tier: 'medium',
    stem_text: 'প্রোপিন-১ এর সাথে জৈব পারঅক্সাইডের উপস্থিতিতে $HBr$ এর বিক্রিয়ায় প্রধান উৎপাদ কোনটি?',
    mcq_options: [
      { key: 'A', text: '১-ব্রোমোপ্রোপেন' },
      { key: 'B', text: '২-ব্রোমোপ্রোপেন' },
      { key: 'C', text: '১,২-ডাইব্রোমোপ্রোপেন' },
      { key: 'D', text: '২,২-ডাইব্রোমোপ্রোপেন' }
    ],
    correct_option: 'A',
    full_solution_latex: '\\text{জৈব পারঅক্সাইডের উপস্থিতিতে খারাশ ফলাফল (বিপরীত মারকভনিকভ নিয়ম) অনুসারে ব্রোমিন কম প্রতিস্থাপিত ১-নং কার্বনে যুক্ত হয়ে ১-ব্রোমোপ্রোপেন গঠন করে।}',
    is_verified: true,
    created_at: '2024-02-01T00:00:00Z'
  },

  // --- HIGHER MATH 1ST & 2ND PAPER MCQS ---
  {
    id: 'q_hmath1_mcq_mat1',
    scope: 'global_official',
    subject_id: 'hmath',
    paper_id: 'hmath_1',
    ...
    question_format: 'MCQ',
    difficulty_tier: 'easy',
    stem_text: '$\\begin{pmatrix} 2 & x \\\\ 4 & 6 \\end{pmatrix}$ ম্যাট্রিক্সটি ব্যতিক্রমী (Singular) হলে $x$ এর মান কত?',
    mcq_options: [
      { key: 'A', text: '3' },
      { key: 'B', text: '-3' },
      { key: 'C', text: '12' },
    ...
    correct_option: 'A',
    full_solution_latex: '\\text{ব্যতিক্রমী ম্যাট্রিক্সের নির্ণায়কের মান শূন্য। } \\det = (2)(6) - (4)(x) = 0 \\implies 12 - 4x = 0 \\implies 4x = 12 \\implies x = 3',
    is_verified: true,
    created_at: '2024-02-01T00:00:00Z'
  },
  {
    id: 'q_hmath1_mcq_line1',
    scope: 'global_official',
    subject_id: 'hmath',
    paper_id: 'hmath_1',
    chapter_id: 'hmath_1_ch3',
    concept_ids: ['hmath_1_ch3_c_straight_line_dist'],
    board: 'Rajshahi',
    exam_year: 2023,
    origin_type: 'board',
    question_format: 'MCQ',
    difficulty_tier: 'medium',
    stem_text: '$3x - 4y + 5 = 0$ এবং $3x - 4y - 15 = 0$ সমান্তরাল সরলরেখাদ্বয়ের মধ্যবর্তী লম্ব দূরত্ব কত?',
    mcq_options: [
      { key: 'A', text: '4' },
      { key: 'B', text: '2' },
      { key: 'C', text: '5' },
    ...
    correct_option: 'A',
    full_solution_latex: 'd = \\frac{|c_1 - c_2|}{\\sqrt{a^2 + b^2}} = \\frac{|5 - (-15)|}{\\sqrt{3^2 + (-4)^2}} = \\frac{20}{\\sqrt{25}} = \\frac{20}{5} = 4',
    is_verified: true,
    created_at: '2024-02-01T00:00:00Z'
  },
  {
    id: 'q_hmath1_mcq_circle1',
    scope: 'global_official',
    subject_id: 'hmath',
    paper_id: 'hmath_1',
    chapter_id: 'hmath_1_ch4',
    concept_ids: ['hmath_1_ch4_c_circle_equation'],
    board: 'Cumilla',
    exam_year: 2024,
    origin_type: 'board',
    question_format: 'MCQ',
    difficulty_tier: 'easy',
    stem_text: '$x^2 + y^2 - 4x + 6y - 12 = 0$ বৃত্তটির ব্যাসার্ধ ($r$) কত একক?',
    mcq_options: [
      { key: 'A', text: '5' },
      { key: 'B', text: '25' },
      { key: 'C', text: '4' },
    ...
    correct_option: 'A',
    full_solution_latex: 'g = -2, \\ f = 3, \\ c = -12 \\implies r = \\sqrt{g^2 + f^2 - c} = \\sqrt{(-2)^2 + 3^2 - (-12)} = \\sqrt{4 + 9 + 12} = \\sqrt{25} = 5',
    is_verified: true,
    created_at: '2024-02-01T00:00:00Z'
  },
  {
    id: 'q_hmath2_mcq_comp1',
    scope: 'global_official',
    subject_id: 'hmath',
    paper_id: 'hmath_2',
    chapter_id: 'hmath_2_ch3',
    concept_ids: ['hmath_2_ch3_c_complex_roots'],
    board: 'Dhaka',
    exam_year: 2024,
    origin_type: 'board',
    question_format: 'MCQ',
    difficulty_tier: 'medium',
    stem_text: 'এককের একটি কাল্পনিক ঘনমূল $\\omega$ হলে $(1 + \\omega - \\omega^2)(1 - \\omega + \\omega^2)$ এর মান কত?',
    mcq_options: [
      { key: 'A', text: '4' },
      { key: 'B', text: '-4' },
      { key: 'C', text: '2' },
    ...
    correct_option: 'A',
    full_solution_latex: '1 + \\omega + \\omega^2 = 0 \\implies 1 + \\omega = -\\omega^2, \\ 1 + \\omega^2 = -\\omega \\\\ (-\\omega^2 - \\omega^2)(-\\omega - \\omega) = (-2\\omega^2)(-2\\omega) = 4\\omega^3 = 4(1) = 4',
    is_verified: true,
    created_at: '2024-02-01T00:00:00Z'
  },
  {
    id: 'q_hmath2_mcq_conic1',
    scope: 'global_official',
    subject_id: 'hmath',
    paper_id: 'hmath_2',
    chapter_id: 'hmath_2_ch6',
    ...
    question_format: 'MCQ',
    difficulty_tier: 'easy',
    stem_text: '$y^2 = 16x$ পরাবৃত্তটির উপকেন্দ্রিক লম্বের দৈর্ঘ্য কত?',
    mcq_options: [
      { key: 'A', text: '16' },
      { key: 'B', text: '4' },
      { key: 'C', text: '8' },
    ...
    correct_option: 'A',
    full_solution_latex: 'y^2 = 4ax = 4(4)x \\implies a = 4\\text{। উপকেন্দ্রিক লম্বের দৈর্ঘ্য } |4a| = |4 \\times 4| = 16',
    is_verified: true,
    created_at: '2024-02-01T00:00:00Z'
  },
  ...
  // --- BIOLOGY & ICT MCQS ---
  {
    id: 'q_bio2_mcq_blood1',
    scope: 'global_official',
    subject_id: 'bio',
    paper_id: 'bio_2',
    chapter_id: 'bio_2_ch4',
    concept_ids: ['bio_2_ch4_c_blood_circulation'],
    board: 'Dhaka',
    exam_year: 2024,
    origin_type: 'board',
    question_format: 'MCQ',
    difficulty_tier: 'easy',
    stem_text: 'সার্বজনীন দাতা (Universal Donor) রক্তের গ্রুপ কোনটি?',
    mcq_options: [
      { key: 'A', text: '$O^+$' },
      { key: 'B', text: '$O^-$' },
      { key: 'C', text: '$AB^+$' },
    ...
    correct_option: 'B',
    full_solution_latex: '\\text{O-Negative (}O^-\\text{) রক্তে কোনো A, B বা Rh অ্যান্টিজেন থাকে না, তাই এটি যেকোনো গ্রুপের গ্রহীতাকে নিরাপদে প্রদান করা যায়।}',
    is_verified: true,
    created_at: '2024-02-01T00:00:00Z'
  },
  {
    ...
    question_format: 'MCQ',
    difficulty_tier: 'easy',
    stem_text: '$(1101)_2$ বাইনারি সংখ্যার সমতুল্য দশমিক মান কত?',
    mcq_options: [
      { key: 'A', text: '11' },
      { key: 'B', text: '13' },
      { key: 'C', text: '15' },
    ...
    correct_option: 'B',
    full_solution_latex: '(1101)_2 = 1 \\times 2^3 + 1 \\times 2^2 + 0 \\times 2^1 + 1 \\times 2^0 = 8 + 4 + 0 + 1 = 13',
    is_verified: true,
    created_at: '2024-02-01T00:00:00Z'
  },
  {
    ...
    question_format: 'MCQ',
    difficulty_tier: 'easy',
    stem_text: 'নিচের কোন দুটি গেটকে সর্বজনীন গেট (Universal Gate) বলা হয়?',
    mcq_options: [
      { key: 'A', text: 'AND ও OR' },
      { key: 'B', text: 'NAND ও NOR' },
      { key: 'C', text: 'XOR ও XNOR' },
      { key: 'D', text: 'NOT ও AND' }
    ],
    correct_option: 'B',
    full_solution_latex: '\\text{NAND ও NOR গেট দিয়ে যেকোনো মৌলিক লজিক ফাংশন বাস্তবায়ন করা যায় বলে এদের সর্বজনীন গেট বলে।}',
    is_verified: true,
    created_at: '2024-02-01T00:00:00Z'
  }
];
